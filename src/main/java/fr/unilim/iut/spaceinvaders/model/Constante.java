...
public class Constante {
	...
	public static final int ENVAHISSEUR_POSITION_VERTICALE = 50;
	...
	public static final int MESSAGE_FIN_POSITIONX = 300;
	public static final int MESSAGE_FIN_POSITIONY = 350;
